 ...
 */
public class ReservationsBeheerderFragment extends Fragment implements AdminReservationsRecyclerAdapter.OnReturnListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lend_items_beheerder, container, false);

        lend_list = new ArrayList<>();
        lend_items_list_view = view.findViewById(R.id.lend_items_list_view_beheerder);
